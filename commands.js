...
await db.collection('bounties').insertMany([
    {
        "name": "Lokinkajou",
        "species": "Kinkajou",
...
db.bounties.find( {$and:[{location: graasland}]})

// 2. Query for all bounties with a reward worth 10000 or more
db.bounties.find( {$and:[{reward: 10000}]})
...
db.bounties.updateOne( { name: "polarwind" }, { reward:"10000"})
// 2. Remove Lokinkajou
db.bounties.remove({
  "name": "Lokinkajou",
        "species": "Kinkajou",
